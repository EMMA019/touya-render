            ...
            TouyaTheme {
                ...
                when (val screen = state.screen) {
                    ...
                    is Screen.Chat -> ChatScreen(
                        ...
                        gifts = state.gifts,
                        giftedToday = state.giftedToday,
                        giftOpen = state.giftOpen,
                        giftSending = state.giftSending,
                        giftError = state.giftError,
                        giftToast = state.giftToast,
                        ...
                        onToggleGift = viewModel::toggleGift,
                        onGiveGift = viewModel::giveGift,
