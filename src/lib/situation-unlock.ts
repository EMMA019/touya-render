...
import { NSFW_LOCK_HINT, NSFW_MIN_AFFINITY_LEVEL } from "./chat-mode";
...
export const LOCKED_INTIMATE_HINT = NSFW_LOCK_HINT;

export type SituationUnlockContext = {
  daysMet: number;
  now?: Date;
  affinityLevel?: number;
  /** Age + 特別 + NSFW mode. nsfwOnly scenes stay shut without this. */
  nsfwAllowed?: boolean;
};
